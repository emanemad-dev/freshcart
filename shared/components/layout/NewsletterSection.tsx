...
export const NewsletterSection = () => {
  return (
    <section className="py-16 lg:py-20  mx-auto px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-emerald-50/80 via-white to-emerald-50/80 backdrop-blur-sm">
      ...
      {/* Main content grid */}
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-5 md:gap-6 lg:gap-8 items-stretch">
        {/* Newsletter Card - Left Side */}
        <div className="lg:col-span-7 bg-white/80 backdrop-blur-md text-gray-800 p-4 sm:p-6 md:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-emerald-100 hover:border-emerald-200 relative group hover:shadow-emerald-100/50">
          {/* VIP Badge */}
          ...
          <div className="flex flex-col xs:flex-row xs:items-center gap-2 sm:gap-3 mb-2 sm:mb-3 md:mb-4">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-emerald-700 leading-tight">
              50,000+
            </h2>
          ...
          {/* Description */}
          <p className="text-gray-600 text-base lg:text-lg mb-4 sm:mb-5 md:mb-6 font-light flex items-start sm:items-center gap-1.5 sm:gap-2 leading-relaxed">
            <MdOutlineSubscriptions className="text-emerald-500 text-lg md:text-xl flex-shrink-0 mt-0.5 sm:mt-0" />
            <span>
          ...
          <div className="relative mb-4 sm:mb-5 md:mb-6">
            <div className="relative flex flex-col xs:flex-row gap-2 sm:gap-3">
              <div className="relative flex-1">
                <MdOutlineEmail className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-emerald-400 text-lg md:text-xl" />
                <Input
                  type="email"
                  placeholder="your@email.com"
                  className="bg-white/80 backdrop-blur-sm text-gray-900 placeholder-gray-400 border-2 border-emerald-100 pl-10 sm:pl-12 py-3 sm:py-4 rounded-lg sm:rounded-xl text-sm sm:text-base font-medium focus:ring-2 focus:ring-emerald-300/50 focus:border-emerald-300 shadow-sm hover:shadow-md transition-all duration-300"
                />
              </div>
              <Button className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-bold px-4 sm:px-6 md:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl shadow-md hover:shadow-lg text-sm sm:text-base h-auto whitespace-nowrap transition-all duration-300 group w-full xs:w-auto">
        ...
        <div className="lg:col-span-5 bg-[#152531] text-white flex flex-col items-center lg:items-start p-4 sm:p-6 md:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-cyan-400/30 relative group hover:shadow-cyan-500/20">
          {/* App Badge */}
          ...
          {/* Title */}
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-black mb-3 md:mb-4 text-center lg:text-left leading-tight">
            Shop on the Go
          ...
          {/* Description */}
          <p className="text-gray-300 text-base lg:text-lg mb-5 md:mb-6 font-light text-center lg:text-left leading-relaxed">
            ...
            {[
              ...
              >
                ...
                <div className="text-left flex-1">
                  ...
                  <p className="text-base md:text-lg font-bold">{app.store}</p>
                </div>
