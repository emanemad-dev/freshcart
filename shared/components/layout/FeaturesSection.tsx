import { BiSolidTruck, BiRotateLeft, BiSolidCreditCard, BiHeadphone } from 'react-icons/bi';

export function FeaturesSection() {
  const features = [
    { icon: BiSolidTruck, title: 'Free Shipping', desc: 'On orders over 500 EGP' },
    { icon: BiRotateLeft, title: 'Easy Returns', desc: '14-day return policy' },
    { icon: BiSolidCreditCard, title: 'Secure Payment', desc: '100% secure checkout' },
